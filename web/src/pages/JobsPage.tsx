...
export function JobsPage(props: { jobRows: JobRow[]; loading: boolean; error: string | null; onRetry: () => void; onGoComposer: () => void }) {
  const { jobRows, loading, error, onRetry, onGoComposer } = props;
  return (
    <div>
      ...
      <div className="card" style={{ padding: '20px 22px' }}>
        {loading ? (
          ...
          <CardEmpty message="No jobs configured yet." />
        ) : (
